...
const STATUS_OPTS = [
  { value: "New", label: "新名單", color: "bg-slate-500" }, // 中性灰：等待開發
  { value: "Warming", label: "暖身中", color: "bg-rose-500" }, // 玫瑰紅：關係升溫
  { value: "Invited", label: "已邀約", color: "bg-violet-500" }, // 紫羅蘭：關鍵行動
  { value: "FollowUp", label: "跟進中", color: "bg-cyan-500" }, // 青色：持續對話
  { value: "Closed", label: "已成交", color: "bg-emerald-500" }, // 翡翠綠：達成目標
  { value: "Lost", label: "暫緩", color: "bg-zinc-900" }, // 深灰：暫時封存
];
...
export default function PeopleManager() {
  ...
  return (
    <div className="h-full w-full bg-[#09090b] text-white flex flex-col font-sans relative overflow-hidden">
      {/* 頂部搜尋與篩選 (翡翠綠風格) */}
      <div className="p-4 border-b border-emerald-500/20 bg-[#051311]/90 backdrop-blur-md z-10 space-y-3 mt-4 rounded-2xl mx-2 shadow-[0_0_30px_rgba(16,185,129,0.1)]">
        <div className="flex gap-3">
          ...
          <button
            onClick={handleAdd}
            className="bg-emerald-600 hover:bg-emerald-500 text-white p-2.5 rounded-xl transition-all shadow-[0_0_15px_rgba(16,185,129,0.4)] active:scale-95 border border-emerald-400/50"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pb-20">
            {filteredPeople.map((person) => (
              <div
                ...
                className="bg-[#0b1210] border border-emerald-500/10 rounded-2xl p-4 relative group cursor-pointer active:scale-[0.98] transition-all hover:border-emerald-500/40 hover:bg-[#111c19] hover:shadow-[0_0_20px_rgba(16,185,129,0.1)]"
              >
                <div
